...
def create_app(test_config=None):
        ...
        return jsonify(
            {
                ...
                'current_category': [],
                'categories': [category.type for category in category]
            }
        )
    ...
    def search_questions():
        ...
        results = Question.query.filter(Question.name.ilike(f'%{search_term}%')).all()
        data = []
    ...
    def get_questions_by_category(id):
        ...
        try:
            selection = Question.quesry.filter_by(category=category.id).all()
            formatted_questions = paginate_questions(request, selection)
